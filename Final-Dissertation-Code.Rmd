...
# match according to the crime_20 synthax
...
# We keep the same boundaries for the no change level.
...
# Assuming 'full_data' contains a geometry column and 'Municipality_type'
